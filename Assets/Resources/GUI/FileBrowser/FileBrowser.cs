...
public class FileBrowser {
	...
	// Optional image for matching files
    public Texture2D FileImageNonMatching {
        get {
            return m_fileImageNonMatching;
        }
        set {
            m_fileImageNonMatching = value;
            BuildContent();
        }
    }
    protected Texture2D m_fileImageNonMatching;
...
//        m_screenRect = screenRect;
    ...
    protected void BuildContent() {
        ...
        for (int i = 0; i < m_nonMatchingFilesWithImages.Length; ++i) {
            m_nonMatchingFilesWithImages[i] = new GUIContent(m_nonMatchingFiles[i], FileImageNonMatching);
        }
    }
